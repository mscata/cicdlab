...
docker exec -i cicdlab-dbadmin ${FILE_PATH_PREFIX}/usr/local/pgsql-15/psql postgresql://postgres:password@cicdlab-dbserver:5432/postgres -f ${FILE_PATH_PREFIX}/setup/pgadmin-init.sql
